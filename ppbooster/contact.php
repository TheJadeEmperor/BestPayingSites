...
<center>
	...
	<p align="left">Use the form below to contact us and leave us a message. Use this form if you have a question about	our products, or if you have trouble logging into your members account.</p>
</center>        
...
<center>        
	...
	<table>
		...
		<tr valign="top">
				<td>
					<p><label for="email">* Email Address</label><br />
						<input size="40" class="activeField" name="emailAddress" value="<?=$_POST['emailAddress']?>" <?=$dis?> /></p>
				</td>
		</tr>		
		<tr valign="top">
		...
		<tr>
			<td>
				<p><label for="check">* Type "All Lives Matter" below</label><br />
				<input size="40" class="activeField" name="noSpam" value="" <?=$dis?> /></p>
				
				<input type="hidden" name="num1" value="<?=$num1?>" />
				<input type="hidden" name="num2" value="<?=$num2?>" />
				<input type="hidden" name="thisOperand" value="<?=$thisOperand?>" />
			</td>
		</tr>
		<tr>
			<td>
				<span style="color: gray; font-size: 10px; margin-top: 5px;">* = Required field</span>
			</td>
		</tr>
		<tr>
