...
?>
<center>
<h3 class="headline">Interested in Promoting <span style="color: #003399"><?=$businessName ?></span> Products?</h1>
</center>
...
<tr>
	<td>
	    <p>First Name</p>
	    <p><input class=activeField name=fname value="<?=$_POST[fname]?>" size=40></p>
    </td>
</tr><tr>
	<td>
	    <p>Last Name</p>
	    <p><input type=text class=activeField name=lname value="<?=$_POST[lname]?>" size=40></p>
    </td>
</tr><tr>
	<td>
	    <p>Username</p>
...
<tr>
	<td colspan=2 align=center>
	    <input type=submit name=register value="Register Now" <?=$disField?> />
